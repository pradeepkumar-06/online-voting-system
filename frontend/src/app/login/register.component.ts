  ...
  template: `
    <div class="glass-panel w-full max-w-sm p-8 mt-20 animate-fade-in-up">
      <div class="text-center mb-8">
        <h2 class="text-3xl font-bold mb-2 text-white">Register</h2>
        <p class="text-gray-400 text-sm">Create an account to vote</p>
      </div>
      ...
      <form (ngSubmit)="onSubmit()" #registerForm="ngForm" class="space-y-6">
        ...
        <div class="mt-4 text-center">
          <a routerLink="/login" class="text-sm text-blue-400 hover:text-blue-300 transition-colors">Already have an account? Sign In</a>
        </div>
      </form>
    </div>
  `
